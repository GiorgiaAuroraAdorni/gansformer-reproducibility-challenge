...
class MetricBase:
    ...
    def run(self, network_pkl, run_dir=None, data_dir=None, dataset_args=None, mirror_augment=None, num_gpus=1, tf_config=None, log_results=True, Gs_kwargs=dict(is_validation=True),ganformer=True):
        ...
        with tf.Graph().as_default(), tflib.create_session(tf_config).as_default(): # pylint: disable=not-context-manager
            ...
            self._evaluate(Gs, Gs_kwargs=Gs_kwargs, num_gpus=num_gpus,ganformer=ganformer)
